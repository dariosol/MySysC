...
int sc_main(int argc, char* argv[])
{
    ...
    sc_trace(f_trace, tb.master->i2c_sda, "i2c_sda");
    ...
    sc_trace(f_trace, tb.slave2->data_in, "slave2_data_in");
    sc_trace(f_trace, tb.slave2->data_out, "slave2_data_out");
    sc_trace(f_trace, tb.slave2->start, "slave2_start");
    sc_trace(f_trace, tb.slave2->write_enable, "slave2_we");
    sc_trace(f_trace, tb.slave2->addr, "slave2_addr");
    sc_trace(f_trace, tb.slave2->sda, "slave2_sda");
    sc_trace(f_trace, tb.slave2->scl, "slave2_scl");
